...
final class UserDefinedLanguagePanelController: NSWindowController, NSTableViewDataSource, NSTableViewDelegate {
    ...
    private func presentEditSheet(for language: UserDefinedLanguage) {
        ...
        keywords2Field.placeholderString = Localization.string(.udlPlaceholderKeywords2, default: "Optional second keyword list")
        ...
        keywords3Field.placeholderString = Localization.string(.udlPlaceholderKeywords3, default: "Optional third keyword list")
        ...
        keywords4Field.placeholderString = Localization.string(.udlPlaceholderKeywords4, default: "Optional fourth keyword list")
        ...
        keywords5Field.placeholderString = Localization.string(.udlPlaceholderKeywords5, default: "Optional fifth keyword list")
        ...
        keywords6Field.placeholderString = Localization.string(.udlPlaceholderKeywords6, default: "Optional sixth keyword list")
        ...
        keywords7Field.placeholderString = Localization.string(.udlPlaceholderKeywords7, default: "Optional seventh keyword list")
        ...
        keywords8Field.placeholderString = Localization.string(.udlPlaceholderKeywords8, default: "Optional eighth keyword list")
        ...
        commentsField.font = NSFont.monospacedSystemFont(ofSize: NSFont.systemFontSize - 1, weight: .regular)
        commentsField.setAccessibilityLabel("Comments keyword list")
        ...
        operators2Field.placeholderString = Localization.string(.udlPlaceholderOperators2, default: "Optional second operators list")
        ...
        numSuffix2Field.placeholderString = Localization.string(.udlPlaceholderNumberSuffix2, default: "Optional second suffix list")
        ...
        numRangeField.placeholderString = Localization.string(.udlPlaceholderNumberRange, default: "e.g. e E (exponent chars)")
        ...
        foldCode1OpenField.placeholderString = Localization.string(.udlPlaceholderFoldCode1Open, default: "e.g. { begin if")
        ...
        foldCode1MiddleField.placeholderString = Localization.string(.udlPlaceholderFoldCode1Middle, default: "e.g. else elseif")
        ...
        foldCode1CloseField.placeholderString = Localization.string(.udlPlaceholderFoldCode1Close, default: "e.g. } end endif")
        ...
        foldCode2OpenField.placeholderString = Localization.string(.udlPlaceholderFoldCode2Open, default: "Optional second open markers")
        ...
        foldCode2MiddleField.placeholderString = Localization.string(.udlPlaceholderFoldCode2Middle, default: "Optional second middle markers")
        ...
        foldCode2CloseField.placeholderString = Localization.string(.udlPlaceholderFoldCode2Close, default: "Optional second close markers")
        ...
        foldCommentOpenField.placeholderString = Localization.string(.udlPlaceholderFoldCommentOpen, default: "Open fold markers inside comments")
        ...
        foldCommentMiddleField.placeholderString = Localization.string(.udlPlaceholderFoldCommentMiddle, default: "Middle fold markers inside comments")
        ...
        foldCommentCloseField.placeholderString = Localization.string(.udlPlaceholderFoldCommentClose, default: "Close fold markers inside comments")
        ...
        let saveEdit = {
            ...
            func setOrRemove(key: String, value: String) {
                let trimmed = value.trimmingCharacters(in: .whitespacesAndNewlines)
                if trimmed.isEmpty { newAdditionalLists.removeValue(forKey: key) }
