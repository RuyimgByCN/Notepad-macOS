...
- Localization: English and Simplified Chinese `Localizable.strings` resources
  ...
  still pending.
- Remaining Notepad++ parity areas include live rectangular multi-caret UI,
  plugin reload/update edge cases, broader view localization, and deeper plugin
  ABI compatibility beyond manifest-driven native commands.
