...
enum AppMenu {
    ...
    static func install(
        ...
        for option in TextEncodingOption.allCases {
            let item = NSMenuItem(
                title: option.displayName,
                action: #selector(EditorWindowController.encodeInEncoding(_:)),
                keyEquivalent: ""
            )
            item.representedObject = option.rawValue
            encodeInMenu.addItem(item)
        }
        ...
        // Style One Token
        let styleOneItem = NSMenuItem(title: "Style One Token", action: nil, keyEquivalent: "")
        let styleOneMenu = NSMenu(title: "Style One Token")
        ...
        // Clear Style
        let clearStyleItem = NSMenuItem(title: "Clear Style", action: nil, keyEquivalent: "")
        let clearStyleMenu = NSMenu(title: "Clear Style")
        ...
        // Jump Up (Previous)
        let jumpUpItem = NSMenuItem(title: "Jump Up", action: nil, keyEquivalent: "")
        let jumpUpMenu = NSMenu(title: "Jump Up")
        ...
        // Jump Down (Next)
        let jumpDownItem = NSMenuItem(title: "Jump Down", action: nil, keyEquivalent: "")
        let jumpDownMenu = NSMenu(title: "Jump Down")
        ...
        // Copy Styled Text
        let copyStyledItem = NSMenuItem(title: "Copy Styled Text", action: nil, keyEquivalent: "")
        let copyStyledMenu = NSMenu(title: "Copy Styled Text")
        ...
        helpMenu.addItem(
            ...
            action: #selector(AppDelegate.openDownloadsPage(_:)),
            keyEquivalent: ""
        ).target = delegate
        helpMenu.addItem(NSMenuItem.separator())
        helpMenu.addItem(
